...
public class Ten_ManagerUpdate extends JPanel {
	...
	private JTextPane txtfieldABeautifulEgg, textPane, txtpnInstockLeft, itemDescPane, itemUpdated, enterNewStock, txtpnShoppingPage;
	private JTextField txtpnOutOfStock, newStockField, textField;
	private JButton updateItem, btnBack;
	...
	private void initialize() {
		...
		newTextPane(enterNewStock, 445, 330, 150, 20, "Enter New Stock: ", 11, "");
		newTextPane(itemUpdated, 458, 500, 350, 20, "", 13, "italic"); 
		newTextPane(txtpnShoppingPage, 20, 25, 400, 52, "Update Stock", 36, "bold"); 
		newTextPane(textPane, 459, 260, 46, 20, "", 13, "");
		newTextPane(txtfieldABeautifulEgg, 459, 140, 300, 55, "Please choose an item to update...", 20, "bold");
		...
		updateItem.setFont(new Font("Monospaced", Font.PLAIN, 12));
